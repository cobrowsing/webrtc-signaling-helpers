...
module.exports = exports = function(config, BASH_COLORS_HELPER) {
    ...
    argv_array.forEach(function(val) {
        ...
        if (val === '--help') {
            ...
            console.log('\tCheck SignalingServer version number.');
            console.log(BASH_COLORS_HELPER.getYellowFG(), '--dependencies');
            console.log('\tCheck all SignalingServer dependencies.');
            ...
            console.log('------------------------------');
            console.log('Need more help? https://github.com/technicalheist/webrtc-signaling-helpers');
            process.exit(1);
        }
    });
